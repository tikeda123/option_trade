...
def main():
    ...
    # DBSCANのパラメータはデータに応じて調整が必要
    dbscan = DBSCAN(eps=0.5, min_samples=5)
    labels = dbscan.fit_predict(X_scaled)
    feature_df['cluster_label'] = labels

    # --- クラスタごとの特徴量平均を出力して確認 ---
    # DBSCANはノイズを -1 のクラスタとして扱う
    ...
    # === 【Pair Plot】===
    # hue='cluster_label' とすることで、DBSCANのクラスタを可視化
    ...
    plt.suptitle("Pair Plot of Selected Features (incl. pct_return) by Cluster (DBSCAN)", y=1.02)
    plt.show()
